...
class ZipCodeModel(TestCase):
    ...
    def test_ok_to_create_zip_in_existing_city(self):
        ...
        test_zip_diff, created = ZipCode.objects.get_or_create(code='19154', city=self.city_philly)
        self.assertEquals(created, 1)

    def test_new_zip_same_city(self):
        """Test the name field of a newly created zip in an existing city"""
        test_zip_diff, created = ZipCode.objects.get_or_create(code='19164', city=self.city_philly)
...
class StateModel(TestCase):
    ...
    def test_short_name_upper(self):
        ...
        test_state, created = State.objects.get_or_create(short_name='nj', name='New Jersey')
...
class GardenAddressTypeModel(TestCase):
    def setUp(self):
        self.gardenaddresstype_py, created = GardenAddressType.objects.get_or_create(address_type='py')
        self.gardenaddresstype_py, created = GardenAddressType.objects.get_or_create(address_type='ml')
    ...
    def test_garden_address_type_physical_str(self):
        ...
        test_garden_address_type = GardenAddressType.objects.get(address_type='py')
        self.assertEquals(str(test_garden_address_type), 'Physical')

    def test_garden_address_type_physical_str(self):
        """Test that the str method returns Mailing for ml"""
        test_garden_address_type = GardenAddressType.objects.get(address_type='ml')
    ...
    def test_address_type_label(self):
        ...
        test_garden_address_type = GardenAddressType.objects.get(address_type='py')
        field_label = test_garden_address_type._meta.get_field('address_type').verbose_name
    ...
    def test_address_type_max_length(self):
        ...
        test_garden_address_type = GardenAddressType.objects.get(address_type='py')
        max_length = test_garden_address_type._meta.get_field('address_type').max_length
        self.assertEquals(max_length, 2)
